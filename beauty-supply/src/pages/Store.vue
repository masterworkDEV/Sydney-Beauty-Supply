<template>
  <main class="min-h-screen">
    <div
      class="bg-[#f1f1f1] h-52 max-sm:h-40 text-center max-xl:px-7 max-sm:px-5 max-sm:pt-10 max-sm:text-center animate__animated animate__fadeInLeft"
    >
      <h1
        class="animate__animated animate__fadeIn animate__delay-2s text-5xl pt-20 max-sm:pt-0 flex mt-7 items-center justify-center text-center tracking-normal max-xl:text-4xl max-md:text-2xl text-[#333]"
      >
        All Products
      </h1>
